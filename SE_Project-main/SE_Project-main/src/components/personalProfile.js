...
export default function Claim() {
    ...
    function fetchClaims(){ // to fetch pending claims
        ...
        var verCl=0
        var verCLA=0
        db.collection("Claims").where("userid", "==", currentUser.uid).orderBy("createdAt","desc")
    ...
    function Claims(){
        ...
        allDocs.map((data) => {
            ...
            return(
                ...
                <div className='col'><Link className="btn-light border rounded" to={`/PersonalClaim/${data.id}`}>View Claim</Link> </div>
                </div>
        ...
        if(user===""){
            ...
            <br></br>
                <div className='row border-bottom'>
                    ...
                    <CreateClaim trigger={popup} setTrigger={setPopup}/>
                    <Button onClick={()=>setPopup(true)}>Create Claim</Button>
                    </div>
                    <br></br>
                    <div className='row'>
                        <h3>Your Claims</h3>
  ...
  return (
    <div>
        ...
        <div className='border-bottom'><h2>User Dashboard</h2></div>
