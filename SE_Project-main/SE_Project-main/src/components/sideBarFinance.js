...
export default function SideBarFinance() {
  ...
  return (
    ...
    <br></br>
            ...
            <Button style={{width:'100%',paddingTop:'20px',paddingBottom:'20px'}} variant="dark shadow-none" onClick={()=>Redirect("/FinanceDashboard")}>Dashboard</Button>
            </div>
            <div className='row' style={{width:'100%',paddingRight:'0' ,textAlign:'right'}}>
            ...
            <div className='row' style={{width:'100%',paddingRight:'0',paddingTop:"310px"}}>
